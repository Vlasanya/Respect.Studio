...
onMounted(() => {
  ...
  if (fullScreen.matches) {
    ...
    gsap.from(".photos__item", { autoAlpha: 0, stagger: 1 }, "-=1.5");
  }
});
...
function animateLogo() {
  ...
  tl.from(".logo__point", { autoAlpha: 0 })
    .from(".logo__big-letters", { autoAlpha: 0 }, "<")
    .from(".logo__small-letters-respect", { autoAlpha: 0, stagger: 0.2 }, "+=0.2")
    .from(".logo__small-letters-studio", { autoAlpha: 0, stagger: 0.2 }, "<");
}
...
function hideLoaderNumbers() {
  gsap.to(".preloader__number", { autoAlpha: 0, duration: 1 });
}
</script>
...
<template>
  <div class="preloader-container">
    <div class="preloader">
      <div ref="loaderNumber" class="preloader__number">{{ currentNumber }}</div>
    </div>
    <svg
      ref="logo"
      class="logo"
    ...
    >
      <g id="Respect Studio title">
        <g id="Group_92" class="group-92">
          ...
          <path
            id="Path_211"
            class="logo__small-letters-respect"
        ...
        <g id="Group_93" class="group-93">
          ...
          <path
            id="Path_218"
            class="logo__small-letters-studio"
        ...
        <g id="Group_94" class="logo__point">
          <path
            id="Path_223"
    ...
    <div class="photos">
      ...
      <div class="photos-items">
        <div class="photos__item" id="item2"></div>
        <div class="photos__item" id="item4"></div>
        <div class="photos__item" id="item5"></div>
      </div>
    </div>
  </div>
</template>
